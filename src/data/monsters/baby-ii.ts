...
const koromon: MonsterDefinition = {
  ...
  baseStats: { hp: 40, atk: 18, def: 14 },
  statCaps: { hp: 100, atk: 45, def: 36 },
  evolutionRequirement: { hp: 22, atk: 14, def: 11, bossWorld: null },
  evolutionPaths: [
